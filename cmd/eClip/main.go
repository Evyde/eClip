...
func main() {
	...
	*/
	...
	mDNSServer, localServiceInfo, serviceListener, selectedInterfaces, err := mdns.RegisterService(monitorCtx, instanceName, mdns.DefaultServiceType, txtRecords)
	if err != nil {
	...
	peerManagerSyncInterval := 5 * time.Second // 用户建议的同步间隔
